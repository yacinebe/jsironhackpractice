...

{
  ...
  cellToPlaceRover.style.backgroundImage="url('../Ironhackexercise3/images/rover-icon-mars-" + rover.color + "-" + rover.direction +".png";
...
function placeObstacles () {
  ...
  cellToPlaceRover.style.backgroundImage="url('../Ironhackexercise3/images/obstacle.png')";
  cellToPlaceRover.style.backgroundSize="cover";
...
function moveForward(rover){
  ...
  switch (rover.direction) {
    ...
    if (((rover.x)+1 < x_boundary)   &&!(isObstacleOnTheWay (rover.x+1, rover.y)) && !(isAnotherRoverOnTheWay (rover.x+1, rover.y)))
    { rover.x=(rover.x)+1; }
